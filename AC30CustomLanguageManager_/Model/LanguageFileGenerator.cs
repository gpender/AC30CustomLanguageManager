...
namespace AC30CustomLanguageManagerApp.Model
{
    ...
    {
        int headerTotalDataSize = 16;
        byte[] fileFormat = new byte[] { 0x00, 0x10 };
        ...
        public LanguageFileHeader(ushort fixedStringCount, ushort softStringCount, ushort bytesPerEntry, Version deviceVersion, UInt32 driveCustomizationSignature)
        {
            ...
            FileLength = (ushort)(headerTotalDataSize + (fixedStringCount * BytesPerEntry) + (softStringCount * BytesPerEntry));
        ...
        public virtual void Initialize(byte[] frame)
        {
            ...
            FileLength = GetBigEndianUshort(hds.fileLength);
        ...
        internal class HeaderDataStructure
        {
            ...
            [MarshalAs(UnmanagedType.ByValArray, SizeConst = 2)]
            public byte[] fileLength = new byte[2];
